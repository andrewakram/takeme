...
//    }
    ...
    {
        $img_name = time().uniqid().'.'.$value->getClientOriginalExtension();
        $value->move(public_path('/uploads/drivers/front_car_images/'),$img_name);
    ...
    public function getFrontCarImageAttribute($value)
    {
        if($value)
        {
            return asset('/uploads/drivers/front_car_images/'.$value);
        }else{
            return "";
            return asset('/default.png');
        }
    ...
    {
        $img_name = time().uniqid().'.'.$value->getClientOriginalExtension();
        $value->move(public_path('/uploads/drivers/back_car_images/'),$img_name);
    ...
    public function getBackCarImageAttribute($value)
    {
        if($value)
        {
            return asset('/uploads/drivers/back_car_images/'.$value);
        }else{
            return "";
            return asset('/default.png');
        }
    ...
    {
        $img_name = time().uniqid().'.'.$value->getClientOriginalExtension();
        $value->move(public_path('/uploads/drivers/insurance_images/'),$img_name);
    ...
    public function getInsuranceImageAttribute($value)
    {
        if($value)
        {
            return asset('/uploads/drivers/insurance_images/'.$value);
        }else{
            return "";
            return asset('/default.png');
        }
    ...
    {
        $img_name = time().uniqid().'.'.$value->getClientOriginalExtension();
        $value->move(public_path('/uploads/drivers/license_images/'),$img_name);
    ...
    public function getLicenseImageAttribute($value)
    {
        if($value)
        {
            return asset('/uploads/drivers/license_images/'.$value);
        }else{
            return "";
            return asset('/default.png');
        }
    ...
    {
        $img_name = time().uniqid().'.'.$value->getClientOriginalExtension();
        $value->move(public_path('/uploads/drivers/civil_images/'),$img_name);
    ...
    public function getCivilImageAttribute($value)
    {
        if($value)
        {
            return asset('/uploads/drivers/civil_images/'.$value);
        }else{
            return "";
            return asset('/default.png');
        }
