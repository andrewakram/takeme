...
@section('content')
    <div class="page-body" dir="rtl">
        ...
        <form class="form-horizontal" method="post"
              action="{{route('updateShopProfile')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-lg-12">
                            <input name="country_name" type="text" placeholder="الدولة" value="{{$shop->country->name}}" class="form-control btn-square" disabled  >
                        </div>
                    </div>
