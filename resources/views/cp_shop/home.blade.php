...
{{--                            </div>--}}
                            <div class="col-sm-4">
                                <div class="selling-update text-center"><i data-feather="anchor"></i>
                                    <h5 class="mb-0 f-18">المناديب المسجلة</h5>
...
{{--                            </div>--}}
                            ...
                            <div class="col-sm-4">
                                <div class="selling-update text-center"><i data-feather="book"></i>
                                    <h5 class="mb-0 f-18">المنتجات</h5>
                                    <h5 class="mb-0 f-18">{{$products}}</h5>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="selling-update text-center"><i data-feather="book"></i>
                                    <h5 class="mb-0 f-18">الطلبات</h5>
                                    <h5 class="mb-0 f-18">{{$orders}}</h5>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="selling-update text-center"><i data-feather="book"></i>
                                    <h5 class="mb-0 f-18">الطلبات اخر 24 ساعة</h5>
                                    <h5 class="mb-0 f-18">{{$ordersIn24Hours}}</h5>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="selling-update text-center"><i data-feather="book"></i>
                                    <h5 class="mb-0 f-18">الطلبات اخر 7 ايام</h5>
                                    <h5 class="mb-0 f-18">{{$ordersIn7Days}}</h5>
                                </div>
                            </div>
{{--                            <div class="col-sm-2">--}}
...
{{--                                <div class="card">--}}
{{--                                    <div class="card-header">--}}
{{--                                        <h4> السائقين اخر سبعه ايام : <span class="digits"></span>--}}
{{--                                        </h4>--}}
{{--                                    </div>--}}
{{--                                    @if($shops_charts)--}}
{{--                                        <div class="card-body chart-block">--}}
...
{{--                                <div class="card">--}}
{{--                                    <div class="card-header">--}}
{{--                                        <h4> الرحلات العاجلة اخر سبعه ايام : <span class="digits"></span>--}}
{{--                                        </h4>--}}
{{--                                    </div>--}}
...
{{--                                <div class="card">--}}
{{--                                    <div class="card-header">--}}
{{--                                        <h4> الرحلات المؤجلة اخر سبعه ايام : <span class="digits"></span>--}}
{{--                                        </h4>--}}
{{--                                    </div>--}}
