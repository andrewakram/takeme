                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center">
                            <img class="align-self-center pull-right img-50 rounded-circle"
                                 src="{{Auth::user()->image}}" alt="header-user">
                        ...
                        <ul class="profile-dropdown onhover-show-div p-20">
                            ...
                            <form id="logout-form" action="{{ route('logout_shop') }}" method="GET" style="display: none;">
                                @csrf
                            </form>
                        </ul>
                    </li>
        ...
        <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                <div class="sidebar-user text-center">
                    <div>
                        <img class="img-60 rounded-circle" src="{{Auth::user()->image}}" alt="#">
...
{{--                    <li><a class="sidebar-header" href="{{route('shop_home')}}"><i data-feather="home"></i>--}}
...
{{--                                    <i class="fa fa-circle"></i><span>المستخدمين</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
...
{{--                    </li>--}}
                    <li>
                        <a class="sidebar-header" href="{{asset('/shop/delegates')}}"><i data-feather="home"></i>
                            <span>المناديب المسجلة</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-header" href="{{asset('/shop/orders')}}"><i data-feather="home"></i>
                            <span>الطلبات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-header" href="{{asset('/shop/offers')}}"><i data-feather="home"></i>
                            <span>العروض</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-header" href="{{asset('/shop/menus')}}"><i data-feather="home"></i>
                            <span>المنيو</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-header" href="{{asset('/shop/products')}}"><i data-feather="home"></i>
                            <span>المنتجات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/shop/edit-dailyWork')}}"><i data-feather="home"></i>
