                ...
                <div class="col-sm-12 col-lg-12 col-xl-12">
                    <div class="table-responsive">
                        <table class="table" id="myTable">
                            ...
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col" style="text-align: center">القيمة المستبدلة</th>
                                <th scope="col" style="text-align: center">النقاط المستبدلة</th>
                                <th scope="col" style="text-align: center">المندوب</th>
...
{{--                                <th scope="col">الاختيارات</th>--}}
                            ...
                            @foreach($countries as $c)
                                <tr id="main_cat_{{$c->id}}" onclick="myFunction({{$c->id}})">
                                    ...
                                    <td style="text-align: center">
                                        @if($c->delegate)
                                            <img src="{{$c->delegate->image}}" width="50px" height="50px"><br>
                                            <b>
                                                <span>الاسم: </span>
                                                <span class="badge badge-dark"> {{$c->delegate->f_name}} {{$c->delegate->l_name}}</span>
                                            </b><br>
                                            <b>
                                                <span>الهاتف: </span>
                                                <span class="badge badge-dark">{{$c->delegate->phone}}</span>
                                            </b><br>
                                            <b>
                                                <span>الايميل: </span>
                                                <span class="badge badge-dark">{{$c->delegate->email}}</span>
                                            </b>
