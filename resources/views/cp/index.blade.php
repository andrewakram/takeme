        ...
        <div class="main-header-right row">
            ...
            <div class="mobile-sidebar d-block">
                <div class="media-body text-right switch-sm">
                    <label class="switch"><a href="{{route('home')}}#"><i id="sidebar-toggle"
...
{{--                        <a class="sidebar-header" href="{{asset('/admin/admins')}}"><i data-feather="home"></i>--}}
{{--                            <span>المشرفين</span>--}}
{{--                            <i class="fa fa-angle-right pull-right"></i>--}}
{{--                        </a>--}}
{{--                        --}}{{--                        <li><a href="{{asset('/admin/admins')}}"><i--}}
{{--                        --}}{{--                                        class="fa fa-circle"></i><span>المشرفين</span></a></li>--}}
{{--                    @endif--}}

                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/shops')}}"><i data-feather="home"></i>
                            <span>المتاجر</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/drivers')}}"><i data-feather="home"></i>
                            <span>السائقين</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/delegates')}}"><i data-feather="home"></i>
                            <span>المناديب</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/clients')}}"><i data-feather="home"></i>
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/countriess')}}"><i data-feather="home"></i>
                            <span>الدول</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                        {{--<ul class="sidebar-submenu">
                            <li><a href="{{asset('/countriess')}}"><i class="fa fa-circle"></i><span>الدول</span></a>
                            </li>
                            <li><a href="{{asset('/govs')}}"><i class="fa fa-circle"></i><span>المحافظات</span></a></li>
                            <li><a href="{{asset('/cities')}}"><i class="fa fa-circle"></i><span>المدن</span></a></li>
                        </ul>--}}

                    </li>
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/cities')}}"><i data-feather="home"></i>
                            <span>المدن</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/nationals')}}"><i data-feather="home"></i>
                            <span>الهويات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>

                        <a class="sidebar-header" href="{{asset('/admin/car_types')}}"><i data-feather="home"></i>
                            <span>انواع سيارات المناديب</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                        {{--<ul class="sidebar-submenu">
                            <li><a href="{{asset('/countriess')}}"><i class="fa fa-circle"></i><span>الدول</span></a>
...
{{--                    <li><a class="sidebar-header" href="{{route('home')}}"><i data-feather="home"></i>--}}
{{--                            <span>المستخدمين</span>--}}
{{--                            <i class="fa fa-angle-right pull-right"></i>--}}
{{--                        </a>--}}
{{--                        <ul class="sidebar-submenu">--}}
...
{{--                    </li>--}}
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/offer_points')}}"><i data-feather="home"></i>
                            <span>عروض النقاط</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/user_offer_points')}}"><i data-feather="home"></i>
                            <span>نقاط المستخدمين المستبدلة</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/delegate_offer_points')}}"><i data-feather="home"></i>
                            <span>نقاط المناديب المستبدلة</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/orders')}}"><i data-feather="home"></i>
                            <span>الطلبات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/carlevelss')}}"><i data-feather="home"></i>
                            <span>مستويات السيارات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    {{--@endif--}}
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/carprices')}}"><i data-feather="home"></i>
                            <span>تعريفة السيارات بالدول </span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    {{--@endif--}}
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/rushhours')}}"><i data-feather="home"></i>
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/reasons')}}"><i data-feather="home"></i>
                            <span>  اسباب الغاء الرحلة </span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    {{--@endif--}}
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/issues')}}"><i data-feather="home"></i>
                            <span>  المشكلات </span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/losts')}}"><i data-feather="home"></i>
                            <span>  المفقودات </span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/bank_transfers')}}"><i data-feather="home"></i>
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/promocodes')}}"><i data-feather="home"></i>
                    ...
                    {{--@if(admin()->hasPermissionTo('View offer'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/trips')}}"><i data-feather="home"></i>
                            <span>الرحلات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    <li><a class="sidebar-header" href="{{asset('/admin/notifications')}}"><i data-feather="home"></i>
                            <span>الاشعارات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
                    ...
                    {{--@if(admin()->hasPermissionTo('View category'))--}}
                    <li><a class="sidebar-header" href="{{asset('/admin/bank_account')}}"><i data-feather="home"></i>
                    ...
                    <li><a class="sidebar-header" href="{{asset('/admin/complains_suggestions')}}"><i
                                    data-feather="home"></i>
                            <span>الشكاوي و المقترحات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>

                    <li><a class="sidebar-header" href="{{asset('/admin/app_explanations')}}"><i
                                    data-feather="home"></i>
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/abouts')}}"><i data-feather="home"></i>
                    ...
                    <li>
                        <a class="sidebar-header" href="{{asset('/admin/settings')}}"><i data-feather="home"></i>
                            <span> الاعدادات</span>
                            <i class="fa fa-angle-right pull-right"></i>
                        </a>
                    </li>
