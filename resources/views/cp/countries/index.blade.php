                                                ...
                                                <form class="form-horizontal" method="post" action="{{route('editCountry')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <input id="name" name="currency" type="text" placeholder="العملة" class="form-control btn-square" value="{{$c->currency}}">
                                                            </div>
                                                        </div>
                ...
                <form class="form-horizontal needs-validation was-validated" method="post" action="{{route('countriess.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-12 control-label text-lg-right" for="textinput"> العملة</label>
                            <div class="col-lg-12">
                                <input id="name" name="currency" type="text" placeholder=" العملة" class="form-control btn-square" >
                            </div>
                        </div>
