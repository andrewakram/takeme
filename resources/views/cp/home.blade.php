                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12 col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4> طلبات المتاجر اخر سبعه ايام :<span class="digits"></span>
                                        </h4>
                                    </div>
                                    @if($users_charts)
                                        <div class="card-body chart-block">
                            ...
                            <div class="col-lg-12 col-sm-12 col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4> الطلبات العادية اخر سبعه ايام :<span class="digits"></span>
                                        </h4>
                                    </div>
                                    @if($users_charts)
                                        <div class="card-body chart-block">
                            ...
                            <div class="col-lg-12 col-sm-12 col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4> المناديب اخر سبعه ايام : <span class="digits"></span>
                                        </h4>
                                    </div>
                                    @if($drivers_charts)
                                        <div class="card-body chart-block">
